...
class Transformer(nn.Module):
    def __init__(self, dim, multiple_of, n_heads, n_layers, norm_eps, vocab_size, max_batch_size=32, max_seq_len=2048, param='7B'):
        ...
        self.cache_size = 1
        self.layer = TransformerBlock(dim, multiple_of, n_heads, norm_eps, param)
...
args_small = {"dim": 512, "multiple_of": 256, "n_heads": 8, "n_layers": 1, "norm_eps": 1e-06, "vocab_size": VOCAB_SIZE, "param": "small"}
